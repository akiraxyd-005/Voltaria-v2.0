...
module.exports = {
    name: 'closetime',
    category: 'admin',
    description: 'Auto-close group after a duration',
    ...
    async execute(sock, msg, args, extra) {
        ...
        if (!durationArg) {
            return extra.reply(`❌ *𝑈𝑠𝑎𝑔𝑒:* §𝑐𝑙𝑜𝑠𝑒𝑡𝑖𝑚𝑒 <𝑑𝑢𝑟𝑎𝑡𝑖𝑜𝑛>\n\n𝐸𝑥𝑎𝑚𝑝𝑙𝑒𝑠:\n§𝑐𝑙𝑜𝑠𝑒𝑡𝑖𝑚𝑒 30𝑠\n§𝑐𝑙𝑜𝑠𝑒𝑡𝑖𝑚𝑒 5𝑚\n§𝑐𝑙𝑜𝑠𝑒𝑡𝑖𝑚𝑒 2ℎ\n§𝑐𝑙𝑜𝑠𝑒𝑡𝑖𝑚𝑒 1𝑑`);
        }
        ...
        await extra.reply(`⏰ *𝐺𝑟𝑜𝑢𝑝 𝑤𝑖𝑙𝑙 𝑐𝑙𝑜𝑠𝑒 𝑖𝑛 ${durationText}*\n\n𝑂𝑛𝑙𝑦 𝑎𝑑𝑚𝑖𝑛𝑠 𝑤𝑖𝑙𝑙 𝑏𝑒 𝑎𝑏𝑙𝑒 𝑡𝑜 𝑠𝑒𝑛𝑑 𝑚𝑒𝑠𝑠𝑎𝑔𝑒𝑠 𝑎𝑓𝑡𝑒𝑟 𝑡ℎ𝑖𝑠 𝑡𝑖𝑚𝑒.`);
        ...
        setTimeout(async () => {
            try {
                ...
                if (!currentMetadata.announce) {
                    ...
                    await sock.sendMessage(extra.from, { text: '🔒 *𝐺𝑟𝑜𝑢𝑝 𝐴𝑢𝑡𝑜-𝐶𝑙𝑜𝑠𝑒𝑑*\n\n𝑇ℎ𝑖𝑠 𝑔𝑟𝑜𝑢𝑝 ℎ𝑎𝑠 𝑏𝑒𝑒𝑛 𝑎𝑢𝑡𝑜𝑚𝑎𝑡𝑖𝑐𝑎𝑙𝑙𝑦 𝑐𝑙𝑜𝑠𝑒𝑑 𝑎𝑠 𝑠𝑐ℎ𝑒𝑑𝑢𝑙𝑒𝑑.' });
                }
